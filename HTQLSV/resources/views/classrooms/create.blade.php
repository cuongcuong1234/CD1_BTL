    ...
    <div class="col-md-8 offset-md-2">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0">Thêm Lớp Học Mới</h5>
            </div>
            <div class="card-body">
                @if($errors->any())
                ...
                <form action="{{ route('classrooms.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="classroom_code" class="form-control @error('classroom_code') is-invalid @enderror" 
                               value="{{ old('classroom_code') }}" required>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="academic_year" class="form-control @error('academic_year') is-invalid @enderror" 
                               value="{{ old('academic_year') }}" placeholder="2025-2026" required>
                        @error('academic_year')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="capacity" class="form-control @error('capacity') is-invalid @enderror" 
                               value="{{ old('capacity', 45) }}" required>
                        @error('capacity')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="d-flex gap-2">
                        <button type="submit" class="btn btn-primary">
                            <i class="bi bi-check-lg"></i> Thêm Lớp
                        </button>
